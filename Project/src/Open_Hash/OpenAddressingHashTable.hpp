...
public:
    ...
    size_t size() const { return m_number_of_elements; } // Retorna o número de elementos na tabela
    bool empty() const { return m_number_of_elements == 0; } // Verifica se a tabela está vazia
    long long get_comparisons() const { return comparisons; } // Retorna o número de comparações realizadas
    long long get_collisions() const { return collisions; } // Retorna o número de colisões ocorridas
};
